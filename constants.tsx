...
export const PRODUCTS: Product[] = [
  {
    ...
    description: {
      ...
      kg: 'Суу өткөрбөйт ПВХ панели, жуунуучу бөлмө жана ашкана үчүн идеалдуу. Тазалоо жана орнотуу оңой.',
  ...
  },
  {
    ...
    name: {
      ...
      kg: 'Ламинат - Табигый эмен (32-класс)',
    ...
    description: {
      ...
      kg: 'Табигый жыгач фактурасы менен бышык 8мм ламинат. Жогорку деңгээлдеги туруктуулук.',
  ...
  },
  {
    ...
    description: {
      ...
      kg: 'Жылуулук жана үн изоляциясы үчүн кийиз негизи бар жогорку сапаттагы линолеум.',
  ...
  },
  {
    ...
    name: {
      ...
      kg: 'Ламинат астындагы төшөлмө (3мм)',
      ru: 'Подложка под ламинат (3мм)'
    },
    category: {
      en: 'Installation Materials',
      kg: 'Орнотуу материалдары',
    ...
    description: {
      ...
      kg: 'Полду түздөө жана үн өткөрбөө үчүн экструдиялык пенополистирол төшөлмөсү.',
  ...
  },
  {
    ...
    description: {
      ...
      kg: 'ПВХ панелдерин дубалга тез жана ишенимдүү орнотуу үчүн атайын желим.',
  ...
  },
  {
    ...
    description: {
      ...
      kg: 'Кабель каналы бар ПВХ плинтусу. Ийкемдүү четтери менен мыкты орнотулат.',
...
export const BISHKEK_LOCATIONS: StoreLocation[] = [
  {
    name: { en: "Main Showroom - Asanaliev", kg: "Башкы дүкөн - Асаналиев", ru: "Главный шоурум - Асаналиева" },
    address: { 
      en: "Asanaliev St, 16/7, Lenin, Bishkek, 720007", 
      kg: "Асаналиев көчөсү, 16/7, Ленин, Бишкек, 720007", 
  ...
  {
    name: { en: "Warehouse North - Dordoi", kg: "Түндүк кампа - Дордой", ru: "Склад Север - Дордой" },
    address: { 
      en: "Dordoi Market, Sector 12, Bishkek", 
      kg: "Дордой базары, 12-сектор, Бишкек", 
